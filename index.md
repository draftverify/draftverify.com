...
description: "DraftVerify establishes the global identification, verification, and traceability standard for non-alcoholic beverages on draft, built on Keg Tags, NFC-enabled Coupler Tags, and the DraftVerify Digital Registry."
---
...
<section class="section">
  <div class="container">
    ...
    <p style="margin:20px 0;font-weight:bold;font-size:1.1rem;">
      If you are not certain, treat the line as alcoholic until verified.
    </p>
