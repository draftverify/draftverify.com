...
<section class="section center" id="why">
  <div class="container">
    ...
    <p style="max-width:820px;margin:0 auto">
      DraftVerify is the global identification and verification standard for non-alcoholic draft.  
      It removes guesswork during busy service by providing a clear, recognizable mark from the cooler to the faucet — ensuring the pour a guest chooses is truly non-alcoholic.
    </p>
  </div>
</section>

<!-- WHY NA NEEDS A STANDARD -->
<section class="section" id="standard">
  <div class="container">
    <div class="kicker center">Why NA Draft Needs a Standard</div>
    <h2 class="h2 center">One Look — No Doubt.</h2>
    <p style="max-width:820px;margin:0 auto">
      Non-alcoholic beer cannot share lines, couplers, or towers with alcoholic products — even trace contamination breaks guest trust and creates brand risk.  
      DraftVerify defines the universal identification and verification protocol that breweries and venues can rely on:
    </p>
    <ul style="max-width:820px;margin:16px auto 0;line-height:1.7">
      <li>Clear, consistent identification from keg to faucet</li>
      <li>Verified keg → line → faucet alignment at each change</li>
      <li>Safe, correct, contamination-free pours</li>
      <li>Simple training teams follow across shifts</li>
    </ul>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid cols-3" style="margin-top:22px">
      <div class="card reveal">
        ...
        <p>Make NA taps easy to spot, easy to explain, and easy to serve.</p>
      </div>
      <div class="card reveal">
        <h3>Breweries &amp; Taprooms</h3>
        <p>Protect NA products with the same clarity and consistency as any other pour.</p>
      </div>
      <div class="card reveal">
        <h3>Distributors &amp; Groups</h3>
        <p>Roll out a recognizable standard guests will trust across locations.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section" id="principles">
  <div class="container">
    ...
    <p style="max-width:820px;margin:0 auto">
      ...
      Teams learn it fast. Guests recognize it instantly. That’s the value of a global standard.
    </p>
  </div>
</section>
  ...
  "mainEntity":[
    {
      ...
      "acceptedAnswer":{
        "@type":"Answer",
        "text":"DraftVerify is the global identification and contamination-prevention standard for non-alcoholic draft — a consistent look from keg to faucet so teams and guests can trust every pour."
      }
    },
    {
      "@type":"Question",
      ...
      "acceptedAnswer":{
        "@type":"Answer",
        "text":"DraftVerify removes guesswork. Staff follow the tag on the keg, the marker on the line, and the holographic sticker at the faucet. Checks are quick and consistent across shifts."
      }
    },
    {
      "@type":"Question",
      ...
      "acceptedAnswer":{
        "@type":"Answer",
        "text":"No. DraftVerify is venue-led and works with standard draft setups. The focus is clear identification and simple practices your team can maintain."
      }
    }
  ]
}
